...
class consultasAvGeneral {
    ...
    public function datosTablaAvanceGeneral($id_vigencia){
        ...
        pdm.nivel as nivel_pdm, sfis.semaforo_seguimiento, sfin.recursos_programados, sfin.recursos_ejecutados, sfin.semaforo_seguimiento_financiero,  DATE_FORMAT(fm.fecha_modificacion ,'%d / %m / %Y') as fecha_modificacion 
