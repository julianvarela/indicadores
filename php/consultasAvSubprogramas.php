...
class consultasAvSubprogramas {
     ...
     */    
    public function datosTablaAvanceSubprogramas(){
        $sql="SELECT m.codigo_nivel_pdm, m.nivel_pdm, sfis.ponderado, sfis.avance_ponderado, sfis.semaforo_seguimiento, sfis.semaforo_seguimiento, sfin.recursos_programados, sfin.recursos_ejecutados, sfin.semaforo_seguimiento_financiero, sfin.fecha_corte
            FROM matriz m, seguimiento_financiero sfin, seguimiento_fisico sfis, vigencias v, fila_matriz fm, clases c, municipios mu, departamentos de
            WHERE v.id='0'            
